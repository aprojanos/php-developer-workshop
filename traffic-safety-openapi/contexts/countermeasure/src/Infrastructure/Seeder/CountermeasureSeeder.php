...
namespace CountermeasureContext\Infrastructure\Seeder;
...
use CountermeasureContext\Infrastructure\Seeder\Exception\MissingCountermeasureTargetReferenceException;
...
final class CountermeasureSeeder
{
        ...
        return [
            ...
            'applicability_rules' => [
                ...
                'intersection_control_types' => array_map(
                    static fn(IntersectionControlType $type) => $type->value,
                    $controlTypes
                ),
            ],
        ...
        return [
            ...
            'applicability_rules' => [
                'road_classifications' => array_map(
                    static fn(RoadClassification $class) => $class->value,
                    $classifications
                ),
            ],
            'affected_collision_types' => $this->pickCollisionTypes(),
    ...
    private function pickCollisionTypes(): array
    {
        ...
        return array_map(static fn(CollisionType $type) => $type->value, $selected);
    }
    ...
    private function pickSeverities(): array
    {
        ...
        return array_map(static fn(InjurySeverity $severity) => $severity->value, $selected);
    }
