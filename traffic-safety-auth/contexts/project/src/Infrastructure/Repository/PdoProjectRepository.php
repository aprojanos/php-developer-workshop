...
namespace ProjectContext\Infrastructure\Repository;

use ProjectContext\Infrastructure\Repository\Exception\ProjectDataIntegrityException;
...
final class PdoProjectRepository implements ProjectRepositoryInterface
{
    ...
    private function fetchProjects(string $sql, array $params = []): array
    {
        ...
        return array_map([$this, 'rowToProject'], $rows);
    }
